...
-- , LVSTEXM.MAXNRM
-- , LVSTEXM.NRMUNIT
, CULTURE_BAC_MED_SENS.BAC_NAME
, CULTURE_BAC_MED_SENS.BAC_HCODE
-- , CULTURE_BAC_MED_SENS.BAC_QTY
, CULTURE_BAC_MED_SENS.MED_NAME
...
OUTER APPLY (
    ...
    LEFT JOIN {{ source('ddc_internal', 'LABORGANISM_ITA') }} LABORGANISM_ITA ON LABORGANISM_ITA.ORGANISM = LVSTEXMBAC1.ORGANISM
